...
def get_storylines(prompt_with_perplexity, crt_length, model,  tokenizer,LM, branch_factor,device):
    '''
    ...
    decoded_tokens_perplexities = expand_storylines(model, LM,input_tokens, branch_factor, \
...
def expand_storylines(model, LM,input_tokens_list, topk, perplexity,crt_length,device):
    new_token_list = []
    check_list = []
